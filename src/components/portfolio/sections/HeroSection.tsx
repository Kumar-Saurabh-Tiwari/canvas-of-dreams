...
export default function HeroSection() {
  return (
    <section id="intro" className="relative min-h-screen flex flex-col justify-between px-6 md:px-16 py-24 font-mono">
      <div className="flex-1 flex flex-col justify-center max-w-6xl">
        <p className="text-[10px] tracking-[0.4em] text-muted-foreground mb-8">[ 01 // INTRO ]</p>
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-8 text-[10px] tracking-[0.3em] text-muted-foreground">
        ...
        <div className="flex items-center gap-3 text-foreground animate-pulse">
